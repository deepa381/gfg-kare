            ...
            <div className="container">
                <div className="text-center mb-16">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                    >
                        Meet Our <span className="text-accent text-transparent bg-clip-text bg-gradient-to-r from-text via-accent to-text">Core Team</span>
                    </motion.h2>
                    <motion.div
                    ...
                    >
                        {team.map((member) => (
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold text-text underline decoration-accent/0 group-hover:decoration-accent/100 transition-all duration-300">{member.name}</h3>
